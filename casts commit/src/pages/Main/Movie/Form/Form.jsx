...
const Form = () => {
  ...
  const handleSearch = useCallback(() => {
    ...
    axios({
      method: 'get',
      url: `https://api.themoviedb.org/3/search/movie?query=${query}&include_adult=false&language=en-US&page=${currentPage}&api_key=43bde163469fc36ca5281d58b7e2e4c0`,
      headers: {
        Accept: 'application/json',
        Authorization: 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI0M2JkZTE2MzQ2OWZjMzZjYTUyODFkNThiN2UyZTRjMCIsIm5iZiI6MTczMzMyOTg2OC4zMTQsInN1YiI6IjY3NTA4M2NjODAxMmY5M2RiYzY5YTUzMiIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.iypkPprIMRvID-j7upsnd5LIJji9C3kJh3YIUziU93c',
      },
    })
      .then((response) => {
